...
import { useDragDropGrid } from '../../../src/hooks/useDragDropGrid';

function TestComponent() {
  const [drop, setDrop] = React.useState<{ item: any; idx: number } | null>(null);
  const {
    pan,
    dragging,
    draggingItem,
...
test('useDragDropGrid supports start/stop and drop flow (grid move)', async () => {
  ...
  // start drag (simulating dragging a hero already placed)
