...
export const CLASS_DEFS: Record<ClassId, ClassDef> = {
  WARRIOR: {
    ...
    baseStatDelta: { hp: 8, atk: 5, defense: 10, crit: 10, agility: 5 },
  ...
  ARCHER: {
    ...
    baseStatDelta: { hp: -3, atk: 6, defense: 2, crit: 20, agility: 25 },
  ...
  MAGE: {
    id: 'MAGE',
    displayName: 'Mago',
    baseStatDelta: { hp: -5, mp: 12, defense: 0, crit: 15, agility: 10 },
  ...
  HEALER: {
    ...
    baseStatDelta: { hp: 10, mp: 8, defense: 5, crit: 5, agility: 12 },
